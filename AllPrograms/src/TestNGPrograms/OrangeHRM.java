...
public class OrangeHRM {
	...
	public void c_addEmployeeStep() throws InterruptedException {
		...
		//Country Dropdown
		ArrayList <WebElement> Country = new ArrayList <WebElement> (driver.findElements(By.xpath("//div[@id='location_inputfileddiv']//ul/li")));
	...
	public void d_personaldetails() throws InterruptedException {
		...
		ArrayList <WebElement> dobyear = new ArrayList <WebElement> (driver.findElements(By.xpath("(//div[@class='select-wrapper picker__select--year'])[1]//ul/li")));
		...
		ArrayList <WebElement> dobmonth = new ArrayList <WebElement> (driver.findElements(By.xpath("(//div[@class='select-wrapper picker__select--month'])[1]//ul/li")));
		...
		ArrayList <WebElement> marrital = new ArrayList <WebElement> (driver.findElements(By.xpath("//div[@id='emp_marital_status_inputfileddiv']//ul/li")));
		...
		ArrayList <WebElement> gender = new ArrayList <WebElement> (driver.findElements(By.xpath("//div[@id='emp_gender_inputfileddiv']//ul/li")));
		...
		ArrayList <WebElement> nation = new ArrayList <WebElement> (driver.findElements(By.xpath("//div[@id='nation_code_inputfileddiv']//ul/li")));
		...
		ArrayList <WebElement> licnseyear = new ArrayList <WebElement> (driver.findElements(By.xpath("(//div[@class='select-wrapper picker__select--year'])[2]//ul/li")));
		...
		ArrayList <WebElement> licnsemonth = new ArrayList <WebElement> (driver.findElements(By.xpath("(//div[@class='select-wrapper picker__select--month'])[2]//ul/li")));
		...
		ArrayList <WebElement> bloodgrp = new ArrayList <WebElement> (driver.findElements(By.xpath("//div[@id='1_inputfileddiv']//ul/li")));
